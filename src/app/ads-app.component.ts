...
//import { OnActivate, RouteSegment, Routes, Router, RouterConfig, ROUTER_DIRECTIVES } from '@angular/router';
...
@Component({
    ...
    directives: [AdListComponent, HeaderComponent, ROUTER_DIRECTIVES], //, ROUTER_DIRECTIVES
